...
$vars = @(
  ...
  @{ key = "RAZORPAY_KEY_ID"; value = "rzp_REPLACE_ME" },
  @{ key = "RAZORPAY_KEY_SECRET"; value = "REPLACE_ME" },
  @{ key = "NEXT_PUBLIC_RAZORPAY_KEY_ID"; value = "rzp_REPLACE_ME" },
  @{ key = "RAZORPAY_WEBHOOK_SECRET"; value = "REPLACE_ME" },
  @{ key = "NEXT_PUBLIC_RAZORPAY_STARTER_PAYMENT_LINK"; value = "https://rzp.io/rzp/REPLACE_ME" },
  @{ key = "NEXT_PUBLIC_RAZORPAY_GROWTH_PAYMENT_LINK"; value = "https://rzp.io/rzp/REPLACE_ME" },
